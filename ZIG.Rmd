...
ZIG was formed in November 2019 at the GLEON all-hands meeting in Huntsville, Canada and has since grown to a team of over 100 aquatic scientists from around the world interested in understanding the uses of zooplankton as indicators in lakes and reservoirs. This project has several goals:

1. **Develop a global dataset:** Our goal is to develop a global zooplankton dataset to test which aspects of zooplankton community structure are the most sensitive, and widely applicable, indicators of environmental change. ZIG’s data call to GLEON can be found [here](ZIG_datacall.pdf). ZIG is planning to publish all or a subset of this data as a data paper. 
...
3. **Launch follow-up questions:** There are many additional questions about zooplankton as indicators that the ZIG global dataset can be used to answer. After the first two goals of the project are met, ZIG's focus will shift to the follow up questions that ZIG participants have outlined. We see the potential for these collaborations to continue well into the future.
