...
I am co-leading a project on zooplankton as ecosystem indicators as part of the Global Lake Ecological Observatory Network [(GLEON)](https://gleon.org/) with over 165 aquatic researchers from around the world. Our first objective is to build the largest freshwater zooplankton dataset known to date and then to use the dataset to answer ecological questions [(Read)](https://doi.org/10.1002/lob.10515). Results from this research will provide guidance on using zooplankton as indicators in geographic regions and lake types. Look [here](https://sfigary.github.io/website/ZIG.html) to learn more about this effort and getting involved.
...
An overarching theme in my research is studying how food webs respond to different factors, including non-native species. While at SUNY ESF, I determined the impact of *Cercopagis pengoi* in the New York Finger Lakes on their likely prey items [(published)](https://www.reabic.net/aquaticinvasions/2021/issue3.aspx) and the pattern of their invasion in the region. More recently, I investigated the impacts of the *Bythotrephes longimanus* invasion on the growth of age-0 yellow perch in Oneida Lake, New York [(Read)](https://doi.org/10.1111/eff.12717).
